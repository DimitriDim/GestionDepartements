...
public class DbInit extends SQLiteOpenHelper {
   ...
   public static DbInit getInstance(Context ctxt) {
        System.out.println("PASSAGE get instance");
        if (instance == null) {
    ...
    public void onCreate(SQLiteDatabase db) {
        System.out.println("Arrivée ON CREAT");
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (11,'ÃŽle-de-France')");
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (43,'Franche-ComtÃ©')");
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (73,'Midi-PyrÃ©nÃ©es')");
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (74,'Limousin')");
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (82,'RhÃ´ne-Alpes')");
        ...
        db.execSQL("INSERT INTO Regions (no_region, nom) VALUES (93,'Provence-Alpes-CÃ´te d''Azur')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('07','82','ArdÃ©che','ARDECHE','5529','1790-03-04T12:00:00','Privas','http://fr.wikipedia.org/wiki/Ard%C3%A8che_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('08','21','Ardennes','ARDENNES','5229','1790-03-04T12:00:00','Charleville-MÃ©ziÃ¨res','http://fr.wikipedia.org/wiki/Ardennes_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('09','73','AriÃ©ge','ARIEGE','4890','1790-03-04T12:00:00','Foix','http://fr.wikipedia.org/wiki/Ari%C3%A8ge_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('13','93','Bouches-du-RhÃ´ne','BOUCHES DU RHONE','5087','1790-03-04T12:00:00','Marseille','http://fr.wikipedia.org/wiki/Bouches-du-Rh%C3%B4ne')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('16','54','Charente','CHARENTE','5956','1790-03-04T12:00:00','AngoulÃªme','http://fr.wikipedia.org/wiki/Charente_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('19','74','CorrÃ©ze','CORREZE','5857','1790-03-04T12:00:00','Tulle','http://fr.wikipedia.org/wiki/Corr%C3%A8ze_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('21','26','CÃ´te d''or','COTE D''OR','8763','1790-03-04T12:00:00','Dijon','http://fr.wikipedia.org/wiki/C%C3%B4te-d%27Or')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('22','53','CÃ´tes d''armor','COTES D''ARMOR','6878','1790-03-04T12:00:00','St-Brieuc','http://fr.wikipedia.org/wiki/C%C3%B4tes-d%27Armor')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('23','74','Creuse','CREUSE','5565','1790-03-04T12:00:00','GuÃ©ret','http://fr.wikipedia.org/wiki/Creuse_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('24','72','Dordogne','DORDOGNE','9060','1790-03-04T12:00:00','PÃ©rigueux','http://fr.wikipedia.org/wiki/Dordogne_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('25','43','Doubs','DOUBS','5234','1790-03-04T12:00:00','BesanÃ§on','http://fr.wikipedia.org/wiki/Doubs_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('26','82','DrÃ´me','DROME','6530','1790-03-04T12:00:00','Valence','http://fr.wikipedia.org/wiki/Dr%C3%B4me_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('29','53','FinistÃ©re','FINISTERE','6733','1790-03-04T12:00:00','Quimper','http://fr.wikipedia.org/wiki/Finist%C3%A8re')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('30','91','Gard','GARD','5853','1790-03-04T12:00:00','NÃ®mes','http://fr.wikipedia.org/wiki/Gard')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('34','91','HÃ©rault','HERAULT','6224','1790-03-04T12:00:00','Montpellier','http://fr.wikipedia.org/wiki/H%C3%A9rault_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('36','24','Indre','INDRE','6903','1790-03-04T12:00:00','ChÃ¢teauroux','http://fr.wikipedia.org/wiki/Indre_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('38','82','IsÃ©re','ISERE','7431','1790-03-04T12:00:00','Grenoble','http://fr.wikipedia.org/wiki/Is%C3%A8re_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('42','82','Loire','LOIRE','4781','1793-08-12T12:00:00','St-Ã‰tienne','http://fr.wikipedia.org/wiki/Loire_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('45','24','Loiret','LOIRET','6775','1790-03-04T12:00:00','OrlÃ©ans','http://fr.wikipedia.org/wiki/Loiret_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('48','91','LozÃ©re','LOZERE','5167','1790-03-04T12:00:00','Mende','http://fr.wikipedia.org/wiki/Loz%C3%A8re_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('50','25','Manche','MANCHE','5938','1790-03-04T12:00:00','St-LÃ´','http://fr.wikipedia.org/wiki/Manche_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('51','21','Marne','MARNE','8162','1790-03-04T12:00:00','ChÃ¢lons-sur-Marne','http://fr.wikipedia.org/wiki/Marne_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('58','26','NiÃ©vre','NIEVRE','6817','1790-03-04T12:00:00','Nevers','http://fr.wikipedia.org/wiki/Ni%C3%A8vre_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('61','25','Orne','ORNE','6103','1790-03-04T12:00:00','AlenÃ§on','http://fr.wikipedia.org/wiki/Orne_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('63','83','Puy de DÃ´me','PUY DE DOME','7970','1790-03-04T12:00:00','Clermont-Ferrand','http://fr.wikipedia.org/wiki/Puy-de-D%C3%B4me')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('64','72','PyrÃ©nÃ©es Atlantiques','PYRENEES ATLANTIQUES','7645','1790-03-04T12:00:00','Pau','http://fr.wikipedia.org/wiki/Pyr%C3%A9n%C3%A9es-Atlantiques')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('65','73','PyrÃ©nÃ©es (Hautes)','HAUTES PYRENEES','4464','1790-03-04T12:00:00','Tarbes','http://fr.wikipedia.org/wiki/Hautes-Pyr%C3%A9n%C3%A9es')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('66','91','PyrÃ©nÃ©es Orientales','PYRENEES ORIENTALES','4116','1790-03-04T12:00:00','Perpignan','http://fr.wikipedia.org/wiki/Pyr%C3%A9n%C3%A9es-Orientales')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('69','82','RhÃ´ne','RHONE','3249','1793-08-12T12:00:00','Lyon','http://fr.wikipedia.org/wiki/Rh%C3%B4ne_(d%C3%A9partement)')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('70','43','SaÃ´ne (Haute)','HAUTE SAONE','5360','1790-03-04T12:00:00','Vesoul','http://fr.wikipedia.org/wiki/Haute-Sa%C3%B4ne')");
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('71','26','SaÃ´ne et Loire','SAONE ET LOIRE','8575','1790-03-04T12:00:00','MÃ¢con','http://fr.wikipedia.org/wiki/Sa%C3%B4ne-et-Loire')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('73','82','Savoie','SAVOIE','6028','1860-06-15T12:00:00','ChambÃ©ry','http://fr.wikipedia.org/wiki/Savoie_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('79','54','SÃ¨vres (Deux)','DEUX SEVRES','5999','1790-03-04T12:00:00','Niort','http://fr.wikipedia.org/wiki/Deux-S%C3%A8vres')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('85','52','VendÃ©e','VENDEE','6720','1790-03-04T12:00:00','La Roche-sur-Yon','http://fr.wikipedia.org/wiki/Vend%C3%A9e_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('88','41','Vosges','VOSGES','5874','1790-03-04T12:00:00','Ã‰pinal','http://fr.wikipedia.org/wiki/Vosges_(d%C3%A9partement)')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('94','11','Val de Marne','VAL DE MARNE','245','1968-01-01T12:00:00','CrÃ©teil','http://fr.wikipedia.org/wiki/Val-de-Marne')");
        ...
        db.execSQL("INSERT INTO departements (no_dept,no_region,nom,nom_std,surface,date_creation,chef_lieu,url_wiki) values ('974','97','RÃ©union','REUNION','2512',Null,'Saint-Denis','http://fr.wikipedia.org/wiki/La_R%C3%A9union')");
    }
